...
//========================================================================================
	...
	void expectSkylerJesseComplete(Flux<User> flux) {
		StepVerifier.create(flux)
				.expectNextMatches(u -> u.getUsername().equalsIgnoreCase("swhite")) // We can use asserNext, too!
				.assertNext(u -> assertThat(u.getUsername()).isEqualToIgnoringCase("jpinkman")) // Alternatively, AssertJ's Assertions can be used, too! Since it accepts a Consumer
				.verifyComplete();
...
//========================================================================================
	...
	void expect3600Elements(Supplier<Flux<Long>> supplier) {
		StepVerifier.withVirtualTime(supplier)
				.thenAwait(Duration.ofHours(1))// which is same as 3600 seconds
