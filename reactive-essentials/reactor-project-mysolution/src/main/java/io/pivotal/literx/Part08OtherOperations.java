...
//========================================================================================
    ...
    Mono<User> useFastestMono(Mono<User> mono1, Mono<User> mono2) {
        // Mono<User> first = Mono.first(mono1, mono2); // Deprecated
        Mono<User> first = Mono.firstWithSignal(mono1, mono2);
...
//========================================================================================
    ...
    Flux<User> useFastestFlux(Flux<User> flux1, Flux<User> flux2) {
        // Flux<User> first = Flux.first(flux1, flux2); // Deprecated
        Flux<User> first = Flux.firstWithSignal(flux1, flux2);
        return first;
    }
